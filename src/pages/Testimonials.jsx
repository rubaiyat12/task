...
const Testimonials = () => {
  return (
    <section id="testimonials" className="pt-32 mb-20 pb-10">
      {/* HEADING */}
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      <div className="md:flex md:justify-between gap-8">
        <motion.div
          className="mx-auto relative bg-[#8ec3b8] max-w-[350px] h-[350px] flex flex-col justify-end p-16 mt-48
        ...
        <motion.div
          className="mx-auto relative bg-[#594f6d] max-w-[350px] h-[350px] flex flex-col justify-end p-16 mt-48
